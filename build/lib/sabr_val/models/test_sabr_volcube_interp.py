...
ir_volcube = irSabrVolCube(ir_vols = df_vol, ir_curve = ir_crv, shift = 0.00, beta = 0.0, left_bounds_extrapolation = True, right_bound_extrapolation = True)
params1 = ir_volcube._interpolate_calibrated_params( 0.25, 0.5)
print(params1)
params1 = ir_volcube._interpolate_calibrated_params( 15.0, 30.0)
print(params1)
params1 = ir_volcube._interpolate_calibrated_params( 0.25, 30.0)
print(params1)
params1 = ir_volcube._interpolate_calibrated_params( 15.0, 0.5)
print(params1)
params1 = ir_volcube._interpolate_calibrated_params( 0.25, 20.0)
print(params1)
params1 = ir_volcube._interpolate_calibrated_params( 0.25, 15.0)
print(params1)
params1 = ir_volcube._interpolate_calibrated_params( 10.0, 0.5)
print(params1)
params1 = ir_volcube._interpolate_calibrated_params( 8.0, 0.5)
print(params1)
